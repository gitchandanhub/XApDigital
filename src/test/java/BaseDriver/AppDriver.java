	     ...
	     @BeforeTest
	      public void Initialize() throws Exception {
	    	 DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");  
	    	   ...
	    	   htmlreporter = new ExtentHtmlReporter("D:\\Software\\Phantom_workspace\\XapDigital\\Result\\Steriaresult.html");
	    	  ...
	    	  FileInputStream fis = new FileInputStream("D:\\Software\\Phantom_workspace\\XapDigital\\src\\test\\java\\property\\config.properties");
	    	  config.load(fis);
